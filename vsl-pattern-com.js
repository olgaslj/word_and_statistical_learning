var VSLPatternCom = (function (jspsych) {
  'use strict';

  const info = {
      name: "vsl-pattern-com",
      parameters: {
  ...
  class VSLPatternComPlugin {
      ...
      trial(display_element, trial) {
          ...
          // display stimulus
          var html = '<div id="jspsych-html-button-response-stimulus">Scegli l\'immagine che completa il meglio la combinazione.</div>';
          //display buttons
          html += '<div id="jspsych-html-button-response-btngroup">';
          var probe_html = '';
          for (var i=0; i<trial.probe.length; i++){
            probe_html += '<img src="' + trial.probe[i] + '" />';
          }
          html += probe_html;
          for (var i = 0; i < choices.length; i++) {
              var image_html = '<img src="' + choices[i] + '" />'
  ...
  VSLPatternComPlugin.info = info;
  return VSLPatternComPlugin;
})(jsPsychModule);
